...
function Run()
	...
	local Action = Rand(6)
	if Action == 0 then	
		if GetFreeLocatorByName("Residence", "Play",1,4, "PlayPos") then
	...
	elseif Action == 1 then	
		if GetFreeLocatorByName("Residence", "Apples",1,4,"PlayPos") then
			if f_BeginUseLocator("","PlayPos",GL_STANCE_STAND,true) then
				if Rand(100)>50 then
	...
	elseif Action == 2 then
		if GetFreeLocatorByName("Residence", "ChildStroll",1,4, "PlayPos") then
			f_MoveTo("","PlayPos",GL_MOVESPEED_RUN,100)
		end
	elseif Action == 3 then
		if GetFreeLocatorByName("Residence", "BearRug",1,4, "PlayPos") then
