...
function Run()
	...
	while true do
		if GetProperty("","BardIsFree")==1 then
			...
			if CityGetRandomBuilding("home", GL_BUILDING_CLASS_MARKET, -1, -1, -1 ,false, "mamarket") then
				if GetOutdoorMovePosition("", "mamarket", "MoveToPosition") then
