...
--  AND0R: Added some new items for female ------------------------------------------------------------------------------------------
		elseif PresentName == "UniqueRedRoses" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
...
--  AND0R: Added some new items for male --------------------------------------------------------------------------------------------
		elseif PresentName == "UniqueBattleofHelsinburg" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueThunderboltBoots" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueSlippers" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueFalx" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueBracers" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueHelmet" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueAxe" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueSword" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
		elseif PresentName == "UniqueCuirass" then
			ProgressModify = 35
			FavorModify = 25
			ItemValue = 5
-------------------------------------------------------------------------------------------------------------------------------------
