		...
		if NumOfObjects>0 then
			...
			for FoundObject=0,NumOfObjects-1 do
				...
				elseif GetCurrentMeasureName(DestAlias)=="ScoutAHouse" and SimGetProfession(DestAlias)==GL_PROFESSION_THIEF then 
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="DemandRansom" and SimGetProfession(DestAlias)==GL_PROFESSION_THIEF then
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="BurgleAHouse" and SimGetProfession(DestAlias)==GL_PROFESSION_THIEF then
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="PlunderBuilding" and ((SimGetProfession(DestAlias)==GL_PROFESSION_THIEF) or (SimGetProfession(DestAlias)==15))then
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="PressProtectionMoney" and SimGetProfession(DestAlias)==15 then 
					DoIt = 1
					break
				...
				elseif GetCurrentMeasureName(DestAlias)=="OrderASabotage_CombustionBomb" and SimGetProfession(DestAlias)==GL_PROFESSION_MYRMIDON then 
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="AssignToLaborOfLove" and SimGetProfession(DestAlias)==30 then  --cocote
					DoIt = 1
					break
				...
				elseif GetCurrentMeasureName(DestAlias)=="AssignToPoisonEnemy" and SimGetProfession(DestAlias)==30 then 
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="PoisonWell" and SimGetProfession(DestAlias)==9 then --alchimist
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="EmbezzlePublicMoney"  and SimGetProfession(DestAlias) == 19 then --dyn chr
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="VerFluchen" and SimGetProfession(DestAlias) == 19 then
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="AddPamphlet" and SimGetProfession(DestAlias) == 19 then
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="Quacksalver" and SimGetProfession(DestAlias)==31 then --Medic
					DoIt = 1
					break
				elseif GetCurrentMeasureName(DestAlias)=="Betrugen"  and SimGetProfession(DestAlias)==41 then --bankier
					DoIt = 1
					break
				end
			end
