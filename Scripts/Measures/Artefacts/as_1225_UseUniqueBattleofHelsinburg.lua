...
--	OVERVIEW "as_1225_UseUniqueBattleofHelsinburg"
--	ANDOR: With this artifact, the player can increase his Fighting & Constitution skills by 4 points.
-------------------------------------------------------------------------------------------------------------------------------------

function Run()

	if IsStateDriven() then
		local ItemName = "UniqueBattleofHelsinburg"
...
--  Read a book
	...
	if RemoveItems("","UniqueBattleofHelsinburg",1)>0 then
		AddImpact("","Fighting",skillmodify,duration)
		AddImpact("","constitution",skillmodify,duration)
		AddImpact("","UniqueBattleofHelsinburg",1,duration)
