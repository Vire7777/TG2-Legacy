...
function Start()
	...
	CityGetBuildings("#Capital",GL_BUILDING_CLASS_PUBLICBUILDING,GL_BUILDING_TYPE_TOWNHALL,-1,-1,FILTER_IGNORE,"CouncilBuilding")

	Alias = "CouncilBuilding0"

	CopyAlias(Alias,"#CouncilBuilding")
